$(window).scroll(function () {
  ...
  if (wScroll > $("#img7").offset().top - 600) {
    $("#img7").addClass("muncul");
  } else {
    $("#img7").removeClass("muncul");
  }
  if (wScroll > $("#img8").offset().top - 600) {
    $("#img8").addClass("muncul");
  } else {
    $("#img8").removeClass("muncul");
  }
  if (wScroll > $("#img9").offset().top - 600) {
    $("#img9").addClass("muncul");
  } else {
    $("#img9").removeClass("muncul");
  }
  if (wScroll > $("#img10").offset().top - 600) {
    $("#img10").addClass("muncul");
  } else {
    $("#img10").removeClass("muncul");
  }
